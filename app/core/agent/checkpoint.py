...
class CheckpointManager:
    ...
    def from_sqlite(cls, path: str) -> "CheckpointManager":
        ...
        if not _sqlite_available:
            raise ImportError("SQLite checkpoint saver is not available. Install langgraph-checkpoint-sqlite")
    ...
    def from_postgres(cls, connection_string: str) -> "CheckpointManager":
        ...
        if not _postgres_available:
            raise ImportError("PostgreSQL checkpoint saver is not available. Install langgraph-checkpoint-postgres")
