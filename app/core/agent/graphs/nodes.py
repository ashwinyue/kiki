...
def _get_tool_node():
    ...
    from app.core.agent.tools import get_tool_node as _get_tool_node_impl
...
def get_llm_with_tools(
    ...
    Returns:
        绑定工具的 LLM 实例
    """
    from app.core.agent.tools import list_tools
...
def chat_node(
    ...
    raise NotImplementedError(
        "请使用 create_chat_node_factory(llm_service, system_prompt) "
        "创建配置好的聊天节点"
    )
